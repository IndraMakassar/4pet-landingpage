          ...
          <div className="flex gap-5 max-md:flex-col max-md:gap-0">
            <div className="flex flex-col w-[63%] max-md:ml-0 max-md:w-full">
              <div className="flex flex-col grow mt-12 text-black max-md:mt-10 max-md:max-w-full">
                <div className="text-8xl font-bold leading-[80px] max-md:max-w-full max-md:text-4xl max-md:leading-9">
                  Happy Pet
                  <br />
                  Happy Breeding
                </div>
                <div className="mt-4 text-2xl leading-5 max-md:max-w-full">
